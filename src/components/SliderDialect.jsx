...
const array = [
  ...
  { pic: DialectImg, btnLabel: 'Play now!', label: 'Kapampangan', bgColor: 'aqua', desc: "Kapampangan is derived from the root word pampáng ('riverbank'). The language was historically spoken in the Kingdom of Tondo, ruled by the Lakans. A number of Kapampangan dictionaries and grammar books were written during the Spanish colonial period.", showPopup: false },
  { pic: DialectImg, btnLabel: 'Play now!', label: 'Cebuano', bgColor: '#7FBCD2', desc: "The Cebuano language is a descendant of the hypothesized reconstructed Proto-Philippine language, which in turn descended from Proto-Malayo-Polynesian, making it distantly related to many languages in Maritime Southeast Asia, including Indonesian and Malay.", showPopup: false },
